      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-[2.25rem] border border-white/10 bg-white/10 shadow-2xl backdrop-blur-xl">
        <div className="p-8">
          <div className="flex items-center justify-between">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-300 text-3xl shadow-lg shadow-amber-950/30">
              ☕
            </div>
          ...
          <div className="mt-8">
            <p className="text-sm font-black uppercase tracking-[0.32em] text-amber-200">Caffein Cafe</p>
